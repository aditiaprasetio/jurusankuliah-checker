...
let DeptFamilySubjectController = class DeptFamilySubjectController {
    constructor(service) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, deptfamilysubject_entity_1.DeptFamilySubject, Object]),
    __metadata("design:returntype", Promise)
], DeptFamilySubjectController.prototype, "createOne", null);
__decorate([
    crud_1.Override(),
    __param(0, crud_1.ParsedRequest()),
    __param(1, crud_1.ParsedBody()),
    ...
    __metadata("design:returntype", Promise)
], DeptFamilySubjectController.prototype, "createMany", null);
DeptFamilySubjectController = __decorate([
    crud_1.Crud({
        model: {
            type: deptfamilysubject_entity_1.DeptFamilySubject,
        },
        params: {
            id: {
                field: 'id',
    ...
    swagger_1.ApiTags('DeptFamilySubject'),
    common_1.Controller('deptfamilysubject'),
    swagger_1.ApiBearerAuth(),
    __metadata("design:paramtypes", [deptfamilysubject_service_1.DeptFamilySubjectService])
], DeptFamilySubjectController);
exports.DeptFamilySubjectController = DeptFamilySubjectController;
//# sourceMappingURL=deptfamilysubject.controller.js.map