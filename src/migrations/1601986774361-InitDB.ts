...
export class InitDB1601986774361 implements MigrationInterface {
  name = 'InitDB1601986774361';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'CREATE TABLE `profiles` (`id` varchar(255) NOT NULL, `created_at` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `account_id` varchar(255) NOT NULL, `current_status` varchar(255) NULL, `department_id` varchar(255) NULL, `want_department_id` varchar(255) NULL, UNIQUE INDEX `IDX_48f07a756b8f321aa99b06aee1` (`account_id`), PRIMARY KEY (`id`)) ENGINE=InnoDB',
      undefined,
    );
    await queryRunner.query(
      'CREATE TABLE `departments` (`id` varchar(255) NOT NULL, `created_at` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `name` varchar(255) NOT NULL, `description` text NULL, `type` varchar(255) NULL, `url` text NULL, `university_id` varchar(255) NOT NULL, `created_by_id` varchar(255) NULL, `department_family_id` varchar(255) NULL, `meta_created_by` json NULL, UNIQUE INDEX `IDX_8681da666ad9699d568b3e9106` (`name`), PRIMARY KEY (`id`)) ENGINE=InnoDB',
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE `profiles` ADD CONSTRAINT `FK_ea1b130268f67384841db2040c2` FOREIGN KEY (`department_id`) REFERENCES `departments`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `profiles` ADD CONSTRAINT `FK_f77f5e6dc28cf62090b0038d9a0` FOREIGN KEY (`want_department_id`) REFERENCES `departments`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION',
      undefined,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE `profiles` DROP FOREIGN KEY `FK_f77f5e6dc28cf62090b0038d9a0`',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `profiles` DROP FOREIGN KEY `FK_ea1b130268f67384841db2040c2`',
      undefined,
    );
    await queryRunner.query(
